...
def chat_assistant_old_twp(request):
...
# Create the model
   ...
   # print()
    ...
    return render(request, 'chatbot/chatbot.html', {'users': users, 'response': response_text, 'user_message': user_message})
...
def chat_assistant_old(request):
    obj = [
        ...
        {"order_id": 103, "customer_name": "Charlie",
